        ...
        <div className="flex-1 bg-white border-2 sm:border-4 border-[#1a2a40] p-6 sm:p-10 shadow-lg">
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full bg-[#1a2a40] text-white font-black py-4 uppercase tracking-[0.2em] sm:tracking-[0.3em] hover:bg-[#c5a059] hover:text-[#1a2a40] transition-all shadow-md active:scale-[0.98] disabled:opacity-50 flex items-center justify-center"
                >
                    {loading ? (
                      <>
