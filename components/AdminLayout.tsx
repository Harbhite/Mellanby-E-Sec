      ...
      >
        <div className="p-6 border-b border-white/10 flex justify-between items-center">
          ...
          <button
            ...
            className="lg:hidden text-white/50 hover:text-white focus-visible:ring-2 focus-visible:ring-[#c5a059] focus:outline-none rounded-sm p-1"
          >
      ...
      <div className="flex-1 flex flex-col h-screen overflow-hidden">
        ...
        <header className="bg-white border-b border-[#e0e0dc] p-4 flex items-center lg:hidden">
          <button
            ...
            className="text-[#1a2a40] focus-visible:ring-2 focus-visible:ring-[#c5a059] focus:outline-none rounded-sm p-1"
          >
