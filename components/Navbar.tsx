        ...
        <div className="flex justify-between h-20 items-center">
            ...
            {navItems.map((item) => (
             ...
             {secondaryItems.map((item) => (
              <Link
                key={item.path}
                to={item.path}
                className={`p-2.5 rounded-md transition-all duration-200 text-white/70 hover:text-[#1a2a40] hover:bg-[#c5a059] focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2 focus-visible:ring-offset-[#1a2a40]`}
                title={item.label}
          ...
          <div className="lg:hidden flex items-center">
            <button
              ...
              className="text-white hover:text-[#c5a059] focus:outline-none p-2 focus-visible:ring-2 focus-visible:ring-[#c5a059] rounded-md"
