        ...
        <div className="flex justify-between h-20 items-center">
          ...
          <div className="lg:hidden flex items-center">
            <button
              ...
              className="text-white hover:text-[#c5a059] focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-offset-[#1a2a40] focus-visible:ring-[#c5a059] p-2 rounded"
